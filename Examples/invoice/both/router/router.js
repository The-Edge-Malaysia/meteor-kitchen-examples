...
if(Meteor.isClient) {
	...
	var privateRoutes = ["home_private", "customers", "customers.insert", "customers.details", "customers.edit", "invoices", "invoices.insert", "invoices.details", "invoices.details.items", "invoices.details.insert", "invoices.details.edit", "invoices.edit", "user_settings", "user_settings.change_pass", "logout"];
