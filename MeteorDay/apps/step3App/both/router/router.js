...
if(Meteor.isClient) {
	var publicRoutes = ["home", "about", "login", "register", "forgot_password", "reset_password"];
	var privateRoutes = ["home_private", "user_settings", "user_settings.change_pass", "logout"];
